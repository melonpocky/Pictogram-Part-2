...
import static com.example.pictogram.LoginActivity.CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        btnLogout = view.findViewById(R.id.btnDots);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //submit post without image data
       ...
       /*btnLogout.setOnClickListener(new View.OnClickListener() {
           ...
           private void goLoginActivity() {
            ...
            public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
                ComposeFragment.super.onActivityResult(requestCode, resultCode, data);
